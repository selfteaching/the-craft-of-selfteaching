...
- [Part.1.G 官方教程：The Python Tutorial](Part.1.G.The-Python-Tutorial-local)
...
- [Part.2.D.8 可执行的 Python 文件](Part.2.D.8-main)
...
- [Part.3.B.2 类 —— Python 的实现](Part.3.B.2.classes-2)
...
- [Q 如何成为优秀沟通者](Q.good-communiation)
- [R 自学者的终点](R.finale)
...
- [Appendix C: Jupyterlab 的安装与配置](T-appendix.jupyter-installation-and-setup)
